...
import { MenuItem, InputGroup, Position } from "@blueprintjs/core";
        ...
        return (
            <ListSelect
                ...
                popoverProps={{
                    ...
                    content: <div style={{ maxHeight: "100px", overflowY: "auto" }}></div>
                }}
            >
                <InputGroup
                    style={{ fontSize: "11px", height: "14px", width: "100%", borderRadius: "0px" }}
                    small={true}
                    placeholder="Search..."
                    readOnly={true}
